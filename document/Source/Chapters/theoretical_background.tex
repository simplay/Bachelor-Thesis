...
\begin{figure}[H]
  \centering
  \subfigure[Radiances is photon ray density number of photons per area per solid angle.]{
    \includegraphics[scale=0.25]{background/radiance.png}
    \label{fig:radiance}
  }
~
  \subfigure[Solid angle is the area of a surface patch on a unit sphere which is spanned by a set of directions]{
    \includegraphics[scale=0.33]{background/solidangle.png}
    \label{fig:solidangle}
  }
  
\caption[radiancesolidangleillustration]{Illustration of concept of radiance and solid angle$\footnotemark$.}
