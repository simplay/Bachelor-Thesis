...
\begin{figure}[H]
  ...
  \caption[Comparing Stam's apporach: Gratings]{blup}
...
\begin{figure}[H]
  ...
  \caption[Comparing Stam's apporach: Good Example]{blup}
...
\begin{figure}[H]
  ...
  \caption[Comparing Stam's apporach: Bad Example]{blup}
...
\begin{figure}[H]
  ...
  \caption[Stam's geometrical setup]{Illustration$\footnotemark$ of geometrical setup of Stam's approach where $\omega_i$ is a direction, pointing towards the light source, $\omega_r$ points towards the camera, $n$ is the surface normal, $(u,v,w)$ are the components of position $p$ on the surface and equal $-\omega_i - \omega_r$.}
