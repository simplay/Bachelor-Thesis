...
Last let us consider the graphs for the PQ approach $\ref{alg:sincinterpolation}$ in figure $\ref{fig:baz}$. for blaze grating, differences, but also similarities. 
