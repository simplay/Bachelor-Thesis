...
Differently for our other two gratings, Elaphe and Xenopeltis. For both the renderings, we can see color contribution due to the effect of diffraction. We see much less colorful patterns for Elpahe $\ref{fig:renderingelaphegrating}$ than for Xenopeltis $\ref{fig:renderingxenograting}$. This 

is consistent with the observations in the real world as shown in figure $\ref{fig:snakespecies}$.
