...
% ADD REFERENCE TO FOLLOW UP SECTION in first footnote (scene)
...
More precicely, we have developed a renderer on a Java code basis

Matlab takes heightfield and computes fourier terms
java code reads these terms and performs rendering based on our model


MERGE THIS SOMEWHERE APPROPRIATE
%
Notice that all the necessary computations in order to simulate the effect of diffraction are performed within a fragment shader. This implies that we are modeling pixelwise the effect of diffraction and hence the overall rendering quality and runtime complexity depends on rendering window's resolution.

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% guard

%% provide kind of overview of this chapter


gratings afm images, snake skin
