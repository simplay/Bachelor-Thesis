...
Where $M$ is a transformation from the local space to a reference coordinate system, called world space.




 $C^{-1}$ camera matrix $C$ and $P$ the projection matrix. The camera matrix defines transformation from camera to world coordinates as shown in figure $\ref{fig:cameracoordinatesystem}$.
