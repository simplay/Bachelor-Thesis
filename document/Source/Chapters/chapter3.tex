...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
render: produce a 2d image of a 3d scene as seen from the perspective of a viewer

In rendering we are interested in reproducing a 2d image of a given 3d scene as seen from the perspective of a viewer. 
us: 
...
write purpose of vertex shader
then what input it takes
and then is output and how reads it
