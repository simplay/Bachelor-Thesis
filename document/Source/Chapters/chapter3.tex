...
\begin{figure}[H]
  ...
  \caption[Renderer Architecture]{Renderer Architecture}
...
\begin{figure}[H]
  ...
  \caption[Triangular Mesh]{A triangular mesh represents an object as a set of triangles and a set of vertices.}
