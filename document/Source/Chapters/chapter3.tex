...
Transformation see figure for cam. coordsystem
...
\begin{figure}[H]
  ...
  \caption{camera matrix}
  \label{fig:cameramatrix}
\end{figure}

mention light source
reference to deriviation

\begin{figure}[H]
  \centering
  \includegraphics[scale=0.45]{implementation/dirlightsource.png}
  \caption{dir lightsource}
