...
Figure $\ref{fig:rendererArchitecture}$ outlines the architecture of our renderer. The scene application program task was basically to define the whole scene we is going to be rendered within jrtr later.
