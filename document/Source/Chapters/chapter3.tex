...
% maybe add a footnote about what is a scnee and so on
...
In OpenGL, there are two fundamental shading pipeline stages, vertex- and fragment shadin, applied sequentially.


In this chapter we explain in detail a technique for rendering structural colors due to diffraction effects on natural graings based on the model we have derived in the previouse chapter$\ref{sec:derivations}$.
