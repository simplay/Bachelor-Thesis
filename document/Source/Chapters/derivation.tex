...
and thus gives us a series representation of $p(x,y)$. Next, let us now compute the Fourier Transformation $\mathcal{F}$ of equation $\ref{eq:pxyseries}$ form above:
