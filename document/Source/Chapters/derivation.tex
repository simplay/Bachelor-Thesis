...
Assuming these facts are proven and there actually exists such an $N$, we can make use of $P_{dtft}$ from  for the tristimulus value Y,  from equation $\ref{eq:structuralcolorsslow}$ and we will get:
\begin{align}
Y 
