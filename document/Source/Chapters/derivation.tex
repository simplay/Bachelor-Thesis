...
% TODO apply these fixes:
% write what is Lambda
% write initial text
% from given starting point: Eqn, we derived xyz
% using tristimulus values in order to compute XYZ_CIE colors 
% describe listed equations, and what they are for
