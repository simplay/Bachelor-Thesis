...
In principle, any color sensation in the humper color perception can therefore be described by just three paramters, corresponding to levels of stimulus of the three types of cone cells.
...
Due to distribution of cones in human eye, the tristimulus values depend on over's field of view. CIE defined a color mapping function called standard observer, to eliminate this variable represent an avarage human chromatic response.
