...
Furthermore, there can be additional input be assigned which is not directly interpolated from the output of vertex shader programs. 
Our Fragment shader just uses k1 and k2, the vertex position as trilinearly interpolated values. Everything else  
