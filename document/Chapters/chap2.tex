...
Since all light rays are parallel whenever we are provided by a directional light source, directions and radiance are soame everywhere and thus, above's radiance identity will follow. By plugging this identity into our current rendering equation, we will get:
