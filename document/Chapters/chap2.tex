...
For the $BRDF(w_i, w_r)$ we are going to use the formulation dervied by Stam described above which looks like this:

\begin{align}
 sdfsdf
\end{align}

this will lead us to the following identiy:
