...
In this section, we will show there is an approximation for the inverse Fourier Tranformation of Stam's auxilary function p(x,y). This derivation will rely on the definition of Taylor Series expansion and will further provide an error bound for our approximation approach. Last, we will extend our last findings by the findings derived within this section and get a new identity for our relative BRDF representation.
