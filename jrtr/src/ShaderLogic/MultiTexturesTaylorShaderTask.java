...
public class MultiTexturesTaylorShaderTask extends ShaderTask{
...
//			gl.glUniform4fv(scalingID2, paramFactorCount/2, scalingFactors2, 0);
		...
		if(m.getKValues() != null){
			int kValID = gl.glGetUniformLocation(activeShader.programId(),"kValues");
			gl.glUniform1fv(kValID, m.getKValues().length, m.getKValues(), 0);
		}
