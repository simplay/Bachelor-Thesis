...
//	float d = 72.95372615635891;
	...
	float a = -79.0313754594477;
	float b = 10072.59831410508;
	float c = -259.3230369409527;
	float d = 337.2182735866896;
...
//		vec2 coords = vec2(k*modUV.x/omega, k*modUV.y/omega);
		...
		vec2 modUV = getRotation(k*u,k*v,-phi);
		vec2 coords = vec2(modUV.x/omega, modUV.y/omega);
