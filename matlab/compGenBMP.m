...
function compGenBMP()
    ...
    n = 1;
    out = 'out/';
	%inputIMG = imread("E:/image/100x100stam1dBump.bmp");
    
	inputIMG = imread('C:/Users/single/repos/BA/images/100x100stamBump.bmp');
	...
	if(length(size(inputIMG))==3),
		%for u=1:1:100,
		%	for v=1:1:100,
				%A(u,v) = 0.2126*d_inputIMG(u,v,1) + 0.7152*d_inputIMG(u,v,2) + 0.0722*d_inputIMG(u,v,3); 
