...
public class CameraSceneConstantManager {
	...
	private void defineConstant(){
		...
		constants.add(cs);
		cs = new CameraSceneConstant("snake3", 1.0f, 3.0f, new Vector3f(0, 1, 0), new Point3f(0, 0, 0), false);
		constants.add(cs);
		cs = new CameraSceneConstant("snake4", 10.0f, 25.0f, new Vector3f(0, 1, 0), new Point3f(0, 0, 0), false);
		constants.add(cs);
		cs = new CameraSceneConstant("snake5", 4.0f, 25.0f, new Vector3f(0, 1, 0), new Point3f(0, 0, 0), false);
		constants.add(cs);
